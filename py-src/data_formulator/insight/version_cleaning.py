...
def generate_cleaning_proposals_for_version(
    ...
    *,
    ...
    try:
        # This call reuses an existing profile only when source hash, profiler
        # version, and configuration hash still match the current implementation.
