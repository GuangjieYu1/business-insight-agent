...
def _discover_providers() -> None:
    ...
    requested = os.environ.get("AUTH_PROVIDER", "").strip().lower()
    if not requested or requested == "anonymous":
        return
    ...
    requested_modules = {
        ...
        "oauth2": {"oidc"},
        "github": {"github_oauth"},
        "azure_easyauth": {"azure_easyauth"},
    }
    allowed_modules = requested_modules.get(requested, {requested})
